...
def explain_score_for_advisor(result: dict):
    """Explication simplifiée pour Figma - sans emojis"""
...
def explain_financial_ratios(client_data: dict):
    """Explication simplifiée des ratios"""
    ...
    with col1:
        st.metric(
            ...
            value=f"{credit_ratio:.1f}x",
            help="Nombre de fois les revenus annuels"
        )
